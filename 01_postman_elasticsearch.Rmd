---
title: "CVR-data med ElasticSearch og Postman"
keywords: "ElasticSearch, Postman, CVR-data"
tags: "ElasticSearch, Postman, CVR-data"
output:
  html_document:
    toc: true
    toc_float: true
...
Næste trin er at få en oversigt over indholdet i databasen. Det gør man ved at anmode om at se databasens "mapping". Hvis man er vant til data opdelt i rækker og kolonner, så kan en database organiseret i JSON godt virker lidt overvældende. Løst kan JSON-formattet oversættes til følgende:
...
![Add credentials/password](Inkedauthorize_LI.jpg)
...
Næste trin er at lave en forespørgsel, hvor vi sætter et filter på, hvad data vi skal hente hjem fra databasen.
 ...
 - Tryk på Body. I linjen men "none", "form-data"... Vælg da "raw" og JSON. Ellers får du en fejlmeddelelse. 
 ...
 - Tryk "Send"
 - Under kodestykket du selv har indsat kommer noget nyt kode, som er svaret på den forespørgsel (data). 
...
Overstående forespørgsel giver et væld af informationer. Ved at tilføje "_source" kan vi vælge, at det kun er nogle specifikke fields (kolonner), der udskrives. Nedenfor er det kun informationer i indlejret i `Vrvirksomhed.aarsbeskaeftigelse` og `Vrvirksomhed.penheder`, der udskrives.
...
Samtidig kan size-parameteren i ens body opjusteres til 3.000 observationer. Send herefter din request (tryk Send) og i dit svar kommer nu et scroll-id (se figur nedenfor). 

![Setup scroll](initScroll.png)

Lav en ny Post-request med følgende URL-request: 
